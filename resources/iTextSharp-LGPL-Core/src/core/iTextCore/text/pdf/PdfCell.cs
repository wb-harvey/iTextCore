...
namespace iTextCore.text.pdf {
     ...
     *
     * @see     iTextCore.text.Rectangle
     * @see     iTextCore.text.Cell
     * @see     PdfLine
     * @see     PdfTable
     */
    ...
    public class PdfCell : Rectangle {
        ...
        */
        private float GetBorderWidthInside(int side) {
            ...
            if (useBorderPadding) {
                switch (side) {
                    case iTextCore.text.Rectangle.LEFT_BORDER:
                        width = BorderWidthLeft;
                        break;

                    case iTextCore.text.Rectangle.RIGHT_BORDER:
                        width = BorderWidthRight;
                        break;

                    case iTextCore.text.Rectangle.TOP_BORDER:
