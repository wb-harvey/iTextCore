...
namespace iTextCore.text.pdf {
     ...
     * @see     PdfString
     * @see     PdfFont
     * @see     iTextCore.text.Chunk
     * @see     iTextCore.text.Font
     */
    ...
    public class PdfChunk {
        ...
        internal PdfChunk(Chunk chunk, PdfAction action) {
            ...
            Font f = chunk.Font;
            float size = f.Size;
            if (size == iTextCore.text.Font.UNDEFINED)
                size = 12;
            baseFont = f.BaseFont;
            BaseFont bf = f.BaseFont;
            int style = f.Style;
            if (style == iTextCore.text.Font.UNDEFINED) {
                style = iTextCore.text.Font.NORMAL;
            }
            if (baseFont == null) {
