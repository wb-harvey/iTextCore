...
using iTextCore.text.rtf;
using iTextCore.text.rtf.document.output;
using iTextCore.text.rtf.list;
using ST = iTextCore.text.rtf.style;
using iTextCore.text.rtf.style;
using HF = iTextCore.text.rtf.headerfooter;
using iTextCore.text.rtf.headerfooter;
//using iTextCore.text.rtf;
/*
...
namespace iTextCore.text.rtf.document {
