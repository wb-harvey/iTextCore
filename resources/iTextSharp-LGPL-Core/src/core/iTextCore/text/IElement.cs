...
namespace iTextCore.text {
    ...
    /// <seealso cref="T:iTextCore.text.Chunk"/>
    /// <seealso cref="T:iTextCore.text.Gif"/>
    /// <seealso cref="T:iTextCore.text.Graphic"/>
    /// <seealso cref="T:iTextCore.text.Header"/>
    /// <seealso cref="T:iTextCore.text.Image"/>
    /// <seealso cref="T:iTextCore.text.Jpeg"/>
    /// <seealso cref="T:iTextCore.text.List"/>
    /// <seealso cref="T:iTextCore.text.ListItem"/>
    /// <seealso cref="T:iTextCore.text.Meta"/>
    ...
    /// <seealso cref="T:iTextCore.text.Table"/>
