...
namespace iTextCore.text {
    ...
    /// </summary>
    /// <seealso cref="T:iTextCore.text.BadElementException"/>
    /// <seealso cref="T:iTextCore.text.Document"/>
    /// <seealso cref="T:iTextCore.text.DocWriter"/>
    /// <seealso cref="T:iTextCore.text.IDocListener"/>
