...
namespace UsefulPdfNet.text.html {
    /**
     ...
     *    <STRONG>HtmlWriter.GetInstance(document, global::System.out);</STRONG>
     ...
     *    global::System.err.Println(de.GetMessage());
     * }
        ...
        protected void Write(IElement element, int indent) {
            ...
            switch (element.Type) {
                ...
                case Element.TABLE: {
                    ...
                    os.WriteByte(EQUALS);
                    os.WriteByte(QUOTE);
                    Write(table.Width.ToString(global::System.Globalization.CultureInfo.InvariantCulture));
                    if (!table.Locked){
                        Write("%");
                    }
                    os.WriteByte(QUOTE);
                    ...
                    Write(HtmlTags.CELLPADDING, table.Cellpadding.ToString(global::System.Globalization.CultureInfo.InvariantCulture));
                    Write(HtmlTags.CELLSPACING, table.Cellspacing.ToString(global::System.Globalization.CultureInfo.InvariantCulture));
                    if (table.BorderWidth != Rectangle.UNDEFINED) {
                        Write(HtmlTags.BORDERWIDTH, table.BorderWidth.ToString(global::System.Globalization.CultureInfo.InvariantCulture));
                    }
