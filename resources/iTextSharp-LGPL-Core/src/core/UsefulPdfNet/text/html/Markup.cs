    ...
    public class Markup {
        ...
        public static float ParseLength(string str) {
            ...
            if (pos == 0)
                return 0f;
            if (pos == length)
                return float.Parse(str, global::System.Globalization.NumberFormatInfo.InvariantInfo);
            float f = float.Parse(str.Substring(0, pos), global::System.Globalization.NumberFormatInfo.InvariantInfo);
        ...
        */
        public static float ParseLength(String str, float actualFontSize) {
            ...
            if (pos == 0) return 0f;
            if (pos == length) return float.Parse(str, global::System.Globalization.NumberFormatInfo.InvariantInfo);
            float f = float.Parse(str.Substring(0, pos), global::System.Globalization.NumberFormatInfo.InvariantInfo);
            str = str.Substring(pos);
            // inches
            if (str.StartsWith("in")) {
