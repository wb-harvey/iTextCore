...
namespace UsefulPdfNet.text.html {
    ...
    public sealed class HtmlEncoder {
        ...
        public static String Encode(Color color) {
            ...
            buffer.Append(global::System.Convert.ToString(color.R, 16));
            if (color.G < 16) {
                buffer.Append('0');
            }
            buffer.Append(global::System.Convert.ToString(color.G, 16));
            if (color.B < 16) {
                buffer.Append('0');
            }
            buffer.Append(global::System.Convert.ToString(color.B, 16));
            return buffer.ToString();
        }
