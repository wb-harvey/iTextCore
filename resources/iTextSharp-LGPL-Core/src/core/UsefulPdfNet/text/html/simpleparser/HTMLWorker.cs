    ...
    public class HTMLWorker : ISimpleXMLDocHandler, IDocListener {
        ...
        public virtual void StartElement(String tag, Hashtable h) {
            ...
            if (tag.Equals(HtmlTags.IMAGE)) {
                ...
                if (before != null)
                    img.SpacingBefore = float.Parse(before, global::System.Globalization.NumberFormatInfo.InvariantInfo);
                if (after != null)
                    img.SpacingAfter = float.Parse(after, global::System.Globalization.NumberFormatInfo.InvariantInfo);
            ...
            if (tag.Equals(HtmlTags.UNORDEREDLIST)) {
                ...
                try{
                    list.IndentationLeft = float.Parse(cprops["indent"], global::System.Globalization.NumberFormatInfo.InvariantInfo);
                }catch {
