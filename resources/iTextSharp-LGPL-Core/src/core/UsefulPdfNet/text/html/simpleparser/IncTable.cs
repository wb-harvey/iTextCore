    ...
    public class IncTable {
        ...
        public PdfPTable BuildTable() {
            ...
            if (width == null)
                ...
                if (width.EndsWith("%"))
                    table.WidthPercentage = float.Parse(width.Substring(0, width.Length - 1), global::System.Globalization.NumberFormatInfo.InvariantInfo);
                else {
                    table.TotalWidth = float.Parse(width, global::System.Globalization.NumberFormatInfo.InvariantInfo);
