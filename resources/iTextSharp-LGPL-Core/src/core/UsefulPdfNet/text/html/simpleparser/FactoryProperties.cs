...
namespace UsefulPdfNet.text.html.simpleparser {
    ...
    public class FactoryProperties {
        ...
        private static void SetParagraphLeading(Paragraph p, String leading) {
            ...
            try {
                ...
                float v1 = float.Parse(v, global::System.Globalization.NumberFormatInfo.InvariantInfo);
                if (!tk.HasMoreTokens()) {
                    p.SetLeading(v1, 0);
                    return;
                }
                v = tk.NextToken();
                float v2 = float.Parse(v, global::System.Globalization.NumberFormatInfo.InvariantInfo);
                p.SetLeading(v1, v2);
            }
            catch {
                p.SetLeading(0, 1.5f);
        ...
        public static void CreateParagraph(Paragraph p, ChainedProperties props) {
            ...
            if (value != null) {
                try {
                    p.SpacingBefore = float.Parse(value, global::System.Globalization.NumberFormatInfo.InvariantInfo);
                }
                catch {}
            }
            value = props["after"];
            if (value != null) {
                try {
                    p.SpacingAfter = float.Parse(value, global::System.Globalization.NumberFormatInfo.InvariantInfo);
                }
                catch {}
            }
            ...
            if (value != null) {
                try {
                    p.ExtraParagraphSpace = float.Parse(value, global::System.Globalization.NumberFormatInfo.InvariantInfo);
                }
                catch {}
            }
        }
        ...
        public Font GetFont(ChainedProperties props) {
            ...
            float size = 12;
            if (value != null)
                size = float.Parse(value, global::System.Globalization.NumberFormatInfo.InvariantInfo);
        ...
        public static void InsertStyle(Hashtable h) {
            ...
            foreach (String key in prop.Keys) {
                if (key.Equals(Markup.CSS_KEY_FONTFAMILY)) {
                    ...
                    String ss = prop[key].Trim().ToLower(global::System.Globalization.CultureInfo.InvariantCulture);
                    h["align"] = ss;
                }
            }
        }
