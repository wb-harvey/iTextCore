    ...
    */
    public class IncCell : ITextElementArray {
        ...
        public IncCell(String tag, ChainedProperties props) {
            ...
            float border = 0;
            if (value != null)
                border = float.Parse(value, global::System.Globalization.NumberFormatInfo.InvariantInfo);
            cell.BorderWidth = border;
            value = props["cellpadding"];
            if (value != null)
                cell.Padding = float.Parse(value, global::System.Globalization.NumberFormatInfo.InvariantInfo);
