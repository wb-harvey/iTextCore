...
namespace UsefulPdfNet.text.html.simpleparser {
    ...
    public class StyleSheet {
        ...
        public void ApplyStyle(String tag, Hashtable props) {
            Hashtable map = (Hashtable)tagMap[tag.ToLower(global::System.Globalization.CultureInfo.InvariantCulture)];
            Hashtable temp;
            if (map != null) {
            ...
            if (cm == null)
                return;
            map = (Hashtable)classMap[cm.ToLower(global::System.Globalization.CultureInfo.InvariantCulture)];
            if (map == null)
                return;
        ...
        public void LoadStyle(String style, Hashtable props) {
            classMap[style.ToLower(global::System.Globalization.CultureInfo.InvariantCulture)] = props;
        }

        public void LoadStyle(String style, String key, String value) {
            style = style.ToLower(global::System.Globalization.CultureInfo.InvariantCulture);
        ...
        public void LoadTagStyle(String tag, Hashtable props) {
            tagMap[tag.ToLower(global::System.Globalization.CultureInfo.InvariantCulture)] = props;
        }

        public void LoadTagStyle(String tag, String key, String value) {
            tag = tag.ToLower(global::System.Globalization.CultureInfo.InvariantCulture);
