...
namespace UsefulPdfNet.text {
    ...
    /// </summary>
    /// <seealso cref="T:UsefulPdfNet.text.RectangleReadOnly"/>
    ...
    /** This is the Penguin large paparback format. */
        ...
        */
        public static Rectangle GetRectangle(String name)  {
            name = name.Trim().ToUpper(global::System.Globalization.CultureInfo.InvariantCulture);
            ...
            if (pos == -1) {
                ...
                try {
                    ...
                    return new Rectangle(float.Parse(width, global::System.Globalization.NumberFormatInfo.InvariantInfo), float.Parse(height, global::System.Globalization.NumberFormatInfo.InvariantInfo));
                } catch(Exception e) {
