...
namespace UsefulPdfNet.text {
    ...
    /// </summary>
    /// <seealso cref="T:UsefulPdfNet.text.BadElementException"/>
    /// <seealso cref="T:UsefulPdfNet.text.Document"/>
    /// <seealso cref="T:UsefulPdfNet.text.DocWriter"/>
    /// <seealso cref="T:UsefulPdfNet.text.IDocListener"/>
