...
using UsefulPdfNet.text.rtf.parser;
using UsefulPdfNet.text.rtf.parser.ctrlwords;
using UsefulPdfNet.text.rtf.parser.properties;
/*
 ...
 */
namespace UsefulPdfNet.text.rtf.parser.destinations {
    /**
    ...
    */
    ...
    //              global::System.out.Print("cell found");
                }
