...
using UsefulPdfNet.text.rtf.direct;
using UsefulPdfNet.text.rtf.document;
using UsefulPdfNet.text.rtf.parser.ctrlwords;
using UsefulPdfNet.text.rtf.parser.destinations;
/*
 ...
 */
namespace UsefulPdfNet.text.rtf.parser {
    ...
    */
    ...
    //      long startTime = global::System.CurrentTimeMillis();
    //      long startFree = Runtime.GetRuntime().FreeMemory();
    //      global::System.out.Println("1:");
    ...
    //      endTime = global::System.CurrentTimeMillis();
    //      endDate = new Date();
    //      global::System.out.Println("RtfCtrlWordMgr start date: " + startDate.ToLocaleString());
    //      global::System.out.Println("RtfCtrlWordMgr end date  : " + endDate.ToLocaleString());
    //      global::System.out.Println("  Elapsed time    : " + Long.ToString(endTime - startTime) + " milliseconds.");
    //      global::System.out.Println("Begin Constructor RtfCtrlWordMgr , free mem is " + df.Format(startFree / 1024) + "k");
    //      global::System.out.Println("End Constructor RtfCtrlWordMgr , free mem is " + df.Format(endFree / 1024) + "k");
    //      global::System.out.Println("RtfCtrlWordMgr used approximately " + df.Format((startFree - endFree) / 1024) + "k");
    //      
    //      global::System.Gc();
    //      global::System.out.Println("2:");
    //      startDate = new Date();
    //      startTime = global::System.CurrentTimeMillis();
    ...
    //      global::System.out.Println("RtfCtrlWordMgr used approximately " + df.Format((startFree - endFree) / 1024) + "k");
    //      global::System.Gc();
    //      global::System.out.Println("At ed:");
    //      startDate = new Date();
    //      startTime = global::System.CurrentTimeMillis();
    //      startFree = Runtime.GetRuntime().FreeMemory();
    ...
    //          }
        ...
        //          global::System.out.Print("Debug value found\n");
        //      }
