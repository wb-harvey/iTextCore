...
using UsefulPdfNet.text.rtf;
using UsefulPdfNet.text.rtf.document.output;
using UsefulPdfNet.text.rtf.list;
using ST = UsefulPdfNet.text.rtf.style;
using UsefulPdfNet.text.rtf.style;
using HF = UsefulPdfNet.text.rtf.headerfooter;
using UsefulPdfNet.text.rtf.headerfooter;
//using UsefulPdfNet.text.rtf;
/*
...
namespace UsefulPdfNet.text.rtf.document {
