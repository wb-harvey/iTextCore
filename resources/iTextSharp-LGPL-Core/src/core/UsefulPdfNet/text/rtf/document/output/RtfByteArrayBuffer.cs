...
namespace UsefulPdfNet.text.rtf.document.output {
        ...
        */
        ...
        private void WriteLoop(byte[] src, int off, int len) {
            while(len > 0) {
                ...
                global::System.Array.Copy(src, off, buffer, pos, n);
                len -= n;
                off += n;
                pos += n;
                size += n;
        ...
        */
        public byte[] ToArray()
        {
            ...
            for(int k = 0; k < n; k++) {
                ...
                global::System.Array.Copy(src, 0, r, off, src.Length);
                off += src.Length;
            }
            if(pos > 0) global::System.Array.Copy(buffer, 0, r, off, pos);
            return(r);
        }
        ...
        */
        ...
        private void FlushBuffer(int reqSize) {
            ...
            if(pos == buffer.Length) {
                ...
                byte[] c = new byte[pos];
                global::System.Array.Copy(buffer, 0, c, 0, pos);
                arrays.Add(c);              
            }
            pos = 0;            
        }
