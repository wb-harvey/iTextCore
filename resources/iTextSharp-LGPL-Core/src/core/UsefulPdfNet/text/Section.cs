        ...
        */
        ...
        public void Set(Properties attributes) {
            ...
            if ((value = attributes.Remove(ElementTags.INDENT)) != null) {
                Indentation = float.Parse(value, global::System.Globalization.NumberFormatInfo.InvariantInfo);
            }
            if ((value = attributes.Remove(ElementTags.INDENTATIONLEFT)) != null) {
                IndentationLeft = float.Parse(value, global::System.Globalization.NumberFormatInfo.InvariantInfo);
            }
            if ((value = attributes.Remove(ElementTags.INDENTATIONRIGHT)) != null) {
                IndentationRight = float.Parse(value, global::System.Globalization.NumberFormatInfo.InvariantInfo);
            }
        }
