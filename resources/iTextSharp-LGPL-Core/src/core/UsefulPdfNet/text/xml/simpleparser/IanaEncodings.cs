...
namespace UsefulPdfNet.text.xml.simpleparser {
    ...
    */
    ...
    public class IanaEncodings {
        ...
        public static int GetEncodingNumber(string name) {
            object n = map[name.ToUpper(global::System.Globalization.CultureInfo.InvariantCulture)];
            if (n == null)
                return 0;
            return (int)n;
        }
        ...
        public static Encoding GetEncodingEncoding(string name) {
            String nameU = name.ToUpper(global::System.Globalization.CultureInfo.InvariantCulture);
