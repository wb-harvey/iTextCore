...
using UsefulPdfNet.text.pdf.draw;
using UsefulPdfNet.text.xml.simpleparser;
...
namespace UsefulPdfNet.text.xml {
    ...
    public class ITextHandler : ParserBase {
        ...
        */
        ...
        public void HandleStartingTags(String name, Properties attributes) {
            //global::System.err.Println("Start: " + name);
            ...
            if (IsDocumentRoot(name)) {
                ...
                foreach (string key in attributes.Keys) {
                    ...
                    if (Util.EqualsIgnoreCase(ElementTags.LEFT, key))
                        leftMargin = float.Parse(value, global::System.Globalization.NumberFormatInfo.InvariantInfo);
                    if (Util.EqualsIgnoreCase(ElementTags.RIGHT, key))
                        rightMargin = float.Parse(value, global::System.Globalization.NumberFormatInfo.InvariantInfo);
                    if (Util.EqualsIgnoreCase(ElementTags.TOP, key))
                        topMargin = float.Parse(value, global::System.Globalization.NumberFormatInfo.InvariantInfo);
                    if (Util.EqualsIgnoreCase(ElementTags.BOTTOM, key))
                        bottomMargin = float.Parse(value, global::System.Globalization.NumberFormatInfo.InvariantInfo);
        ...
        public void HandleEndingTags(String name) {
            ...
            //global::System.err.Println("Stop: " + name);
                ...
                if (ElementTags.ROW.Equals(name)) {
                    ...
                    foreach (Cell c in cells) {
                        ...
                        if (cell.Width == 0) {
                            ...
                            try {
                                cellWidths[j] = float.Parse(width.Substring(0, width.Length - 1), global::System.Globalization.NumberFormatInfo.InvariantInfo);
                                total += cellWidths[j];
                            }
                            catch {
                                // empty on purpose
