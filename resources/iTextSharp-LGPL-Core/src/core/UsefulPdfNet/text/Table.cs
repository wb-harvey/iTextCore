...
namespace UsefulPdfNet.text {
    ...
    ///    </TABLE>
    /// </example>
    /// <seealso cref="T:UsefulPdfNet.text.Rectangle"/>
    /// <seealso cref="T:UsefulPdfNet.text.Element"/>
    /// <seealso cref="T:UsefulPdfNet.text.Row"/>
    ...
    public class Table : Rectangle, ILargeElement {
        ...
        private global::System.Drawing.Point curPosition = new global::System.Drawing.Point(0, 0);
        ...
        */
        ...
        public Table(int columns, int rows) : base(0, 0, 0, 0) {
            ...
            curPosition = new global::System.Drawing.Point(0, 0);
        ...
        */
        ...
        public void AddCell(Cell aCell, int row, int column) {
            AddCell(aCell, new global::System.Drawing.Point(row,column));
        }
        ...
        /// </summary>
        /// <param name="content">a Phrase</param>
        /// <param name="location">a global::System.Drawing.Point</param>
        public void AddCell(Phrase content, global::System.Drawing.Point location) {
        ...
        /// </summary>
        /// <remarks>
        /// This is a shortcut for AddCell(Cell cell, global::System.Drawing.Point location).
        /// The string will be converted to a Cell.
        /// </remarks>
        /// <param name="content">a string</param>
        /// <param name="location">a point</param>
        public void AddCell(string content, global::System.Drawing.Point location) {
        ...
        public void InsertTable(Table aTable, int row, int column) {
            if (aTable == null) throw new Exception("insertTable - table has null-value");
            InsertTable(aTable, new global::System.Drawing.Point(row, column));
        }
        ...
        /// </summary>
        /// <param name="aTable">the table you want to insert</param>
        /// <param name="aLocation">a global::System.Drawing.Point</param>
        public void InsertTable(Table aTable, global::System.Drawing.Point p) {
            if (aTable == null) throw new Exception("insertTable - table has null-value");
        ...
        public void DeleteColumn(int column) {
            ...
            global::System.Array.Copy(widths, 0, newWidths, 0, column);
            global::System.Array.Copy(widths, column + 1, newWidths, column, columns - column);
            Widths = newWidths;
            global::System.Array.Copy(widths, 0, newWidths, 0, columns);
            widths = newWidths;
            Row row;
            int size = rows.Count;
        ...
        */
        ...
        public global::System.Drawing.Dimension Dimension {
            get {
                return new global::System.Drawing.Dimension(columns, rows.Count);
            }
        }
                    ...
                    for (j=0; j < columns; j++) {
                        ...
                        else        // copy others values
                        {
                            ...
                            if (aElement is Cell) {
                                ...
                                PlaceCell(newRows,((Cell) aElement), new global::System.Drawing.Point(lDummyRow,lDummyColumn));
                            }
                        }
            ...
            for (int i=0; i < rows.Count; i++) {
                for (int j=0; j < columns; j++) {
                    if ( ((Row) rows[i]).IsReserved(j) == false) {
                        AddCell(defaultCell, new global::System.Drawing.Point(i, j));
                    }
                }
            }
        }
        ...
        /// <returns></returns>
        private bool IsValidLocation(Cell aCell, global::System.Drawing.Point aLocation) {
        ...
        private void PlaceCell(ArrayList someRows, Cell aCell, global::System.Drawing.Point aPosition) {
            int i;
            Row row = null;
        ...
        /// </summary>
        /// <value>a global::System.Drawing.Point</value>
        private global::System.Drawing.Point CurrentLocationToNextValidPosition {
            set {
                ...
                curPosition = new global::System.Drawing.Point(i, j);
            }
        }
