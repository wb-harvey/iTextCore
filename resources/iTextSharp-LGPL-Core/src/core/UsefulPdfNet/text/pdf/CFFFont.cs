    ...
    public class CFFFont {
        ...
        protected void GetDictItem() {
            ...
            while (!gotKey) {
                ...
                if (b0 == 29) {
                    ...
                    args[arg_count] = item;
                    arg_count++;
                    //global::System.err.Println(item+" ");
                    continue;
                }
                if (b0 == 28) {
                    short item = GetShort();
                ...
                if (b0 == 30) {
                    ...
                    args[arg_count] = item;
                    arg_count++;
                    //global::System.err.Println(" real=["+item+"]");
                    continue;
                }
                if (b0 <= 21) {
                    gotKey=true;
                    ...
                    //  global::System.err.Print(args[i].ToString()+" ");
                    //global::System.err.Println(key+" ;");
                    continue;
                }
            }
        }
        ...
        */
        ...
        protected internal class RangeItem : Item {
            ...
            public override void Emit(byte[] buffer) {
                //global::System.err.Println("range emit offset "+offset+" size="+length);
                buf.Seek(offset);
                for (int i=myOffset; i<myOffset+length; i++)
                    buffer[i] = buf.ReadByte();
                //global::System.err.Println("finished range emit");
            }
        }
        ...
        */
        ...
        protected internal class IndexMarkerItem : Item {
            ...
            public override void Xref() {
                //global::System.err.Println("index marker item, base="+indexBase.myOffset+" my="+this.myOffset);
        ...
        */
        ...
        //throws java.io.FileNotFoundException
        {
            ...
            if ( ! fonts[j].isCID ) {
                ...
                //global::System.err.Println("number of glyphs = "+nglyphs);
            }
            ...
            */
            ...
            if (fonts[j].isCID) {
                ...
                if (fonts[j].privateSubrs >= 0) {
                    //global::System.err.Println("has subrs="+fonts[j].privateSubrs+" ,len="+fonts[j].privateLength);
        ...
        */
        ...
        public CFFFont(RandomAccessFileOrArray inputbuffer) {
            ...
            //global::System.err.Println("CFF: nStdString = "+standardStrings.length);
            buf = inputbuffer;
            Seek(0);
            ...
            //global::System.err.Println("CFF Major-Minor = "+major+"-"+minor);
            
            int hdrSize = GetCard8();
            
            offSize = GetCard8();
            
            //global::System.err.Println("offSize = "+offSize);
            ...
            */
            ...
            for (int j=0; j<nameOffsets.Length-1; j++) {
                ...
                //global::System.err.Println("name["+j+"]=<"+fonts[j].name+">");
            }
            ...
            /*
            global::System.err.Println("std strings = "+standardStrings.length);
            global::System.err.Println("fnt strings = "+(stringOffsets.length-1));
            for (char j=0; j<standardStrings.length+(stringOffsets.length-1); j++) {
                ...
                //}
                global::System.err.Println("j="+(int)j+" <? "+(standardStrings.length+(stringOffsets.length-1)));
                global::System.err.Println("strings["+(int)j+"]=<"+getString(j)+">");
            }
            */
            ...
            for (int j=0; j<topdictOffsets.Length-1; j++) {
                ...
                while (GetPosition() < topdictOffsets[j+1]) {                
                    GetDictItem();
                    if (key=="FullName") {
                        //global::System.err.Println("getting fullname sid = "+((Integer)args[0]).IntValue);
                        fonts[j].fullName = GetString((char)((int)args[0]));
                        //global::System.err.Println("got it");
                    } else if (key=="ROS")
                        fonts[j].isCID = true;
                    else if (key=="Private") {
                        ...
                        //global::System.err.Println("charstrings "+fonts[j].charstringsOffset);
                        // Added by Oren & Ygal
                        int p = GetPosition();
                ...
                if (fonts[j].privateOffset >= 0) {
                    //global::System.err.Println("PRIVATE::");
                ...
                if (fonts[j].fdarrayOffset >= 0) {
                    ...
                    //global::System.err.Println("FD Font::");
            ...
            //global::System.err.Println("CFF: done");
        }
