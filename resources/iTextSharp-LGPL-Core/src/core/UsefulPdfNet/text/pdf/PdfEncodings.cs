...
public class PdfEncodings {
    ...
    public static byte[] ConvertToBytes(string text, string encoding) {
        ...
        IExtraEncoding extra = (IExtraEncoding)extraEncodings[encoding.ToLower(global::System.Globalization.CultureInfo.InvariantCulture)];
        if (extra != null) {
    ...
    public static string ConvertToString(byte[] bytes, string encoding) {
        ...
        String nameU = encoding.ToUpper(global::System.Globalization.CultureInfo.InvariantCulture);
        bool marker = false;
        bool big = false;
        int offset = 0;
        if (bytes.Length >= 2) {
    ...
    */    
    ...
    public static void AddExtraEncoding(String name, IExtraEncoding enc) {
        lock (extraEncodings) { // This serializes concurrent updates
            ...
            newEncodings[name.ToLower(global::System.Globalization.CultureInfo.InvariantCulture)] = enc;
