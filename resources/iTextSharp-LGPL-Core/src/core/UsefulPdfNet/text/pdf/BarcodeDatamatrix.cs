...
using UsefulPdfNet.System.Encodings;
    ...
    public class BarcodeDatamatrix {
        ...
        */
        ...
        private static int B256Encodation(byte[] text, int textOffset, int textLength, byte[] data, int dataOffset, int dataLength) {
            ...
            global::System.Array.Copy(text, textOffset, data, k + dataOffset, textLength);
        ...
        private static int GetEncodation(byte[] text, int textOffset, int textSize, byte[] data, int dataOffset, int dataSize, int options, bool firstMatch) {
            ...
            case DM_RAW:
                if (textSize > dataSize)
                    return -1;
                global::System.Array.Copy(text, textOffset, data, dataOffset, textSize);
                return textSize;
            }
            return -1;
        }
        ...
        * @return the image
        */    
        public virtual global::System.Drawing.Image CreateDrawingImage(global::System.Drawing.Color foreground, global::System.Drawing.Color background) {
            if (image == null)
                return null;
            int h = height + 2 * ws;
            int w = width + 2 * ws;
            int stride = (w + 7) / 8;
            global::System.Drawing.Bitmap bmp = new global::System.Drawing.Bitmap(w, h);
            for (int k = 0; k < h; ++k) {
                int p = k * stride;
                for (int j = 0; j < w; ++j) {
        ...
        */
        ...
        /**
        * Gets/sets the options for the barcode generation. The options can be:<p>
        * One of:<br>
