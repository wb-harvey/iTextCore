...
namespace UsefulPdfNet.text.pdf {
     ...
     *
     * @see     UsefulPdfNet.text.Rectangle
     * @see     UsefulPdfNet.text.Cell
     * @see     PdfLine
     * @see     PdfTable
     */
    ...
    public class PdfCell : Rectangle {
        ...
        */
        private float GetBorderWidthInside(int side) {
            ...
            if (useBorderPadding) {
                switch (side) {
                    case UsefulPdfNet.text.Rectangle.LEFT_BORDER:
                        width = BorderWidthLeft;
                        break;

                    case UsefulPdfNet.text.Rectangle.RIGHT_BORDER:
                        width = BorderWidthRight;
                        break;

                    case UsefulPdfNet.text.Rectangle.TOP_BORDER:
