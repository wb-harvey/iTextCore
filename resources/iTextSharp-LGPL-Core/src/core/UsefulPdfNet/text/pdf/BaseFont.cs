...
namespace UsefulPdfNet.text.pdf {
    ...
    public abstract class BaseFont {
        ...
        */    
        ...
        public const string RESOURCE_PATH = "UsefulPdfNet.UsefulPdfNet.text.pdf.fonts.";
        ...
        */
        public static BaseFont CreateFont(String name, String encoding, bool embedded, bool cached, byte[] ttfAfm, byte[] pfb, bool noThrow, bool forceRead) {
            ...
            else if (nameBase.ToLower(global::System.Globalization.CultureInfo.InvariantCulture).EndsWith(".ttf") || nameBase.ToLower(global::System.Globalization.CultureInfo.InvariantCulture).EndsWith(".otf") || nameBase.ToLower(global::System.Globalization.CultureInfo.InvariantCulture).IndexOf(".ttc,") > 0) {
        ...
        internal virtual byte[] ConvertToBytes(string text) {
            ...
            if (specialMap != null) {
                ...
                if (ptr < length) {
                    ...
                    global::System.Array.Copy(b, 0, b2, 0, ptr);
                    return b2;
                }
                else
                    return b;
        ...
        */
        ...
        public static string[][] GetFullFontName(string name, string encoding, byte[] ttfAfm) {
            string nameBase = GetBaseName(name);
            BaseFont fontBuilt = null;
            if (nameBase.ToLower(global::System.Globalization.CultureInfo.InvariantCulture).EndsWith(".ttf") || nameBase.ToLower(global::System.Globalization.CultureInfo.InvariantCulture).EndsWith(".otf") || nameBase.ToLower(global::System.Globalization.CultureInfo.InvariantCulture).IndexOf(".ttc,") > 0)
