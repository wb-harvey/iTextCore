...
namespace UsefulPdfNet.text.pdf {
    ...
    internal class Type1Font : BaseFont {
        ...
        */
        ...
        internal Type1Font(string afmFile, string enc, bool emb, byte[] ttfAfm, byte[] pfb, bool forceRead) {
            ...
            else if (afmFile.ToLower(global::System.Globalization.CultureInfo.InvariantCulture).EndsWith(".afm")) {
                try {
                    if (ttfAfm == null)
            ...
            else if (afmFile.ToLower(global::System.Globalization.CultureInfo.InvariantCulture).EndsWith(".pfm")) {
                try {
        ...
        public void Process(RandomAccessFileOrArray rf) {
            ...
            while ((line = rf.ReadLine()) != null) {
                ...
                if (ident.Equals("FontName"))
                    ...
                    ItalicAngle = float.Parse(tok.NextToken(), global::System.Globalization.NumberFormatInfo.InvariantInfo);
                    ...
                    llx = (int)float.Parse(tok.NextToken(), global::System.Globalization.NumberFormatInfo.InvariantInfo);
                    lly = (int)float.Parse(tok.NextToken(), global::System.Globalization.NumberFormatInfo.InvariantInfo);
                    urx = (int)float.Parse(tok.NextToken(), global::System.Globalization.NumberFormatInfo.InvariantInfo);
                    ury = (int)float.Parse(tok.NextToken(), global::System.Globalization.NumberFormatInfo.InvariantInfo);
                }
                else if (ident.Equals("UnderlinePosition"))
                    UnderlinePosition = (int)float.Parse(tok.NextToken(), global::System.Globalization.NumberFormatInfo.InvariantInfo);
                else if (ident.Equals("UnderlineThickness"))
                    UnderlineThickness = (int)float.Parse(tok.NextToken(), global::System.Globalization.NumberFormatInfo.InvariantInfo);
                else if (ident.Equals("EncodingScheme"))
                    EncodingScheme = tok.NextToken("\u00ff").Substring(1);
                else if (ident.Equals("CapHeight"))
                    CapHeight = (int)float.Parse(tok.NextToken(), global::System.Globalization.NumberFormatInfo.InvariantInfo);
                else if (ident.Equals("XHeight"))
                    XHeight = (int)float.Parse(tok.NextToken(), global::System.Globalization.NumberFormatInfo.InvariantInfo);
                else if (ident.Equals("Ascender"))
                    Ascender = (int)float.Parse(tok.NextToken(), global::System.Globalization.NumberFormatInfo.InvariantInfo);
                else if (ident.Equals("Descender"))
                    Descender = (int)float.Parse(tok.NextToken(), global::System.Globalization.NumberFormatInfo.InvariantInfo);
                else if (ident.Equals("StdHW"))
                    StdHW = (int)float.Parse(tok.NextToken(), global::System.Globalization.NumberFormatInfo.InvariantInfo);
                else if (ident.Equals("StdVW"))
                    StdVW = (int)float.Parse(tok.NextToken(), global::System.Globalization.NumberFormatInfo.InvariantInfo);
            ...
            while ((line = rf.ReadLine()) != null) {
                ...
                while (tok.HasMoreTokens())
                {
                    ...
                    if (ident.Equals("C"))
                        ...
                        WX = (int)float.Parse(tokc.NextToken(), global::System.Globalization.NumberFormatInfo.InvariantInfo);
            ...
            while ((line = rf.ReadLine()) != null) {
                ...
                if (ident.Equals("KPX")) {
                    ...
                    int width = (int)float.Parse(tok.NextToken(), global::System.Globalization.NumberFormatInfo.InvariantInfo);
