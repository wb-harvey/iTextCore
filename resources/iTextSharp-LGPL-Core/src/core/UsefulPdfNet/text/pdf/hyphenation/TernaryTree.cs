...
namespace UsefulPdfNet.text.pdf.hyphenation {
    /**
    ...
    public class TernaryTree : ICloneable {
         ...
         */
        public void Balance() {
            // global::System.out.Print("Before root splitchar = "); global::System.out.Println(sc[root]);
            ...
            // global::System.out.Print("After root splitchar = "); global::System.out.Println(sc[root]);
        }
        ...
        public virtual void PrintStats() {
             ...
             * if ( kv[i] != 0 )
             * global::System.out.Print(kv[i]);
             * else
             * global::System.out.Println("");
             * global::System.out.Println("Keys:");
             * for (Enumeration enum = Keys(); enum.HasMoreElements(); )
             * global::System.out.Println(enum.NextElement());
             */
