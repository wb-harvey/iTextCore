...
namespace UsefulPdfNet.text.pdf {
    ...
    internal class TrueTypeFontUnicode : TrueTypeFont, IComparer {
        ...
        internal TrueTypeFontUnicode(string ttFile, string enc, bool emb, byte[] ttfAfm, bool forceRead) {
            ...
            if ((fileName.ToLower(global::System.Globalization.CultureInfo.InvariantCulture).EndsWith(".ttf") || fileName.ToLower(global::System.Globalization.CultureInfo.InvariantCulture).EndsWith(".otf") || fileName.ToLower(global::System.Globalization.CultureInfo.InvariantCulture).EndsWith(".ttc")) && ((enc.Equals(IDENTITY_H) || enc.Equals(IDENTITY_V)) && emb)) {
        ...
        */
        ...
        internal static string ToHex(int n) {
            if (n < 0x10000)
                return "<" + global::System.Convert.ToString(n, 16).PadLeft(4, '0') + ">";
            n -= 0x10000;
            int high = (n / 0x400) + 0xd800;
            int low = (n % 0x400) + 0xdc00;
            return "[<" + global::System.Convert.ToString(high, 16).PadLeft(4, '0') + global::System.Convert.ToString(low, 16).PadLeft(4, '0') + ">]";
        }
