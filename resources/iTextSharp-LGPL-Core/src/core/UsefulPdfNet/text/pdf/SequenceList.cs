                ...
                while (true) {
                    ...
                    if (c == EOT) {
                        if (state == DIGIT) {
                            ...
                            other = buf.ToString().ToLower(global::System.Globalization.CultureInfo.InvariantCulture);
                            return TEXT;
                        }
                        return END;
                    }
        ...
        */    
        public static ArrayList Expand(String ranges, int maxNumber) {
            ...
            while (!sair) {
                ...
                //global::System.out.Println("low="+parse.low+",high="+parse.high+",odd="+parse.odd+",even="+parse.even+",inverse="+parse.inverse);
                int inc = 1;
                if (parse.inverse) {
