...
namespace UsefulPdfNet.text.pdf {
    ...
    */
    public class AcroFields {
                ...
                if (tk.TokenType == PRTokeniser.TK_OTHER) {
                    ...
                    if (oper.Equals("Tf")) {
                        if (stack.Count >= 2) {
                            ...
                            ret[DA_SIZE] = float.Parse((String)stack[stack.Count - 1], global::System.Globalization.NumberFormatInfo.InvariantInfo);
                        }
                    }
                    else if (oper.Equals("g")) {
                        if (stack.Count >= 1) {
                            float gray = float.Parse((String)stack[stack.Count - 1], global::System.Globalization.NumberFormatInfo.InvariantInfo);
                            if (gray != 0)
                        ...
                        if (stack.Count >= 3) {
                            float red = float.Parse((String)stack[stack.Count - 3], global::System.Globalization.NumberFormatInfo.InvariantInfo);
                            float green = float.Parse((String)stack[stack.Count - 2], global::System.Globalization.NumberFormatInfo.InvariantInfo);
                            float blue = float.Parse((String)stack[stack.Count - 1], global::System.Globalization.NumberFormatInfo.InvariantInfo);
                            ret[DA_COLOR] = new Color(red, green, blue);
                        }
                    }
                    else if (oper.Equals("k")) {
                        if (stack.Count >= 4) {
                            float cyan = float.Parse((String)stack[stack.Count - 4], global::System.Globalization.NumberFormatInfo.InvariantInfo);
                            float magenta = float.Parse((String)stack[stack.Count - 3], global::System.Globalization.NumberFormatInfo.InvariantInfo);
                            float yellow = float.Parse((String)stack[stack.Count - 2], global::System.Globalization.NumberFormatInfo.InvariantInfo);
                            float black = float.Parse((String)stack[stack.Count - 1], global::System.Globalization.NumberFormatInfo.InvariantInfo);
        ...
        */    
        public float[] GetFieldPositions(String name) {
            ...
            if (ptr < ret.Length) {
                ...
                global::System.Array.Copy(ret, 0, ret2, 0, ptr);
                return ret2;
            }
            return ret;
        }
        ...
        *    global::System.out.Println("Signature name: " + name);
        *    global::System.out.Println("Signature covers whole document: " + af.SignatureCoversWholeDocument(name));
        *    PdfPKCS7 pk = af.VerifySignature(name);
        *    Calendar cal = pk.GetSignDate();
        *    Certificate pkc[] = pk.GetCertificates();
        *    global::System.out.Println("Subject: " + PdfPKCS7.GetSubjectFields(pk.GetSigningCertificate()));
        *    global::System.out.Println("Document modified: " + !pk.Verify());
        *    Object fails[] = PdfPKCS7.VerifyCertificates(pkc, kall, null, cal);
        *    if (fails == null)
        *        global::System.out.Println("Certificates verified against the KeyStore");
        *    else
        *        global::System.out.Println("Certificate failed: " + fails[1]);
        * }
        * </pre>
        * @param name the signature field name
