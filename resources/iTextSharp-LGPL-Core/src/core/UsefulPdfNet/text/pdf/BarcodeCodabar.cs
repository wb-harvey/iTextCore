    ...
    public class BarcodeCodabar : Barcode{
        ...
        */    
        public static byte[] GetBarsCodabar(String text) {
            text = text.ToUpper(global::System.Globalization.CultureInfo.InvariantCulture);
            int len = text.Length;
            if (len < 2)
        ...
        public static String CalculateChecksum(String code) {
            if (code.Length < 2)
                return code;
            String text = code.ToUpper(global::System.Globalization.CultureInfo.InvariantCulture);
            int sum = 0;
            int len = text.Length;
            for (int k = 0; k < len; ++k)
        ...
        */    
        ...
        public override global::System.Drawing.Image CreateDrawingImage(global::System.Drawing.Color foreground, global::System.Drawing.Color background) {
            String fullCode = code;
            if (generateChecksum && checksumText)
                fullCode = CalculateChecksum(code);
            if (!startStopText)
            ...
            global::System.Drawing.Bitmap bmp = new global::System.Drawing.Bitmap(fullWidth, height);
            for (int h = 0; h < height; ++h) {
                bool print = true;
                int ptr = 0;
                for (int k = 0; k < bars.Length; ++k) {
                    int w = (bars[k] == 0 ? 1 : (int)n);
                    global::System.Drawing.Color c = background;
                    if (print)
                        c = foreground;
                    print = !print;
                    for (int j = 0; j < w; ++j)
