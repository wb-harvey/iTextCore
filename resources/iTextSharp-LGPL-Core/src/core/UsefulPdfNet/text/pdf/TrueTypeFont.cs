    ...
    internal class TrueTypeFont : BaseFont {
        ...
        */
        ...
        internal TrueTypeFont(string ttFile, string enc, bool emb, byte[] ttfAfm, bool justNames, bool forceRead) {
            ...
            if (fileName.ToLower(global::System.Globalization.CultureInfo.InvariantCulture).EndsWith(".ttf") || fileName.ToLower(global::System.Globalization.CultureInfo.InvariantCulture).EndsWith(".otf") || fileName.ToLower(global::System.Globalization.CultureInfo.InvariantCulture).EndsWith(".ttc")) {
        ...
        protected static string GetTTCName(string name) {
            int idx = name.ToLower(global::System.Globalization.CultureInfo.InvariantCulture).IndexOf(".ttc,");
            if (idx < 0)
                return name;
            else
