        ...
        for (;;) {
            ...
            switch (function) {
                ...
                case META_MOVETO:
                {
                    ...
                    global::System.Drawing.Point p = new global::System.Drawing.Point(meta.ReadShort(), y);
                ...
                case META_LINETO:
                {
                    ...
                    global::System.Drawing.Point p = state.CurrentPoint;
                    cb.MoveTo(state.TransformX(p.X), state.TransformY(p.Y));
                    cb.LineTo(state.TransformX(x), state.TransformY(y));
                    cb.Stroke();
                    state.CurrentPoint = new global::System.Drawing.Point(x, y);
                    break;
                }
                case META_POLYLINE:
                {
                ...
                case META_EXTTEXTOUT:
                {
                    ...
                    try {
                        ...
                        s = global::System.Text.ASCIIEncoding.ASCII.GetString(text, 0, k);
                    }
