...
namespace UsefulPdfNet.text.pdf.codec.wmf {
    public class MetaFont : MetaObject {
        ...
        public void Init(InputMeta meta) {
            ...
            try {
                ...
                faceName = global::System.Text.ASCIIEncoding.ASCII.GetString(name, 0, k);
            }
            faceName = faceName.ToLower(global::System.Globalization.CultureInfo.InvariantCulture);
        }
        ...
        public BaseFont Font {
            get {
                if (font != null)
                    return font;
                UsefulPdfNet.text.Font ff2 = FontFactory.GetFont(faceName, BaseFont.CP1252, true, 10, ((italic != 0) ? UsefulPdfNet.text.Font.ITALIC : 0) | ((bold != 0) ? UsefulPdfNet.text.Font.BOLD : 0));
                font = ff2.BaseFont;
                if (font != null)
                    return font;
                string fontName;
