...
//            }
        ...
        */
        public bool VerifyTimestampImprint() {
            ...
            byte[] md = new global::System.Security.Cryptography.SHA1CryptoServiceProvider().ComputeHash(digest);
...
//            File file = new File(global::System.GetProperty("java.home"), "lib");
...
//        }
        ...
        */
        public byte[] GetEncodedPKCS7(byte[] secondDigest, DateTime signingTime, ITSAClient tsaClient, byte[] ocsp) {
            ...
            if (tsaClient != null) {
                byte[] tsImprint = new global::System.Security.Cryptography.SHA1CryptoServiceProvider().ComputeHash(digest);
            ...
            */
            public X509Name(String dirName) {
                ...
                while (nTok.HasMoreTokens()) {
                    ...
                    String id = token.Substring(0, index).ToUpper(global::System.Globalization.CultureInfo.InvariantCulture);
