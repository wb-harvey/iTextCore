...
namespace UsefulPdfNet.text.pdf {
     ...
     * @see     PdfString
     * @see     PdfFont
     * @see     UsefulPdfNet.text.Chunk
     * @see     UsefulPdfNet.text.Font
     */
    ...
    public class PdfChunk {
        ...
        internal PdfChunk(Chunk chunk, PdfAction action) {
            ...
            Font f = chunk.Font;
            float size = f.Size;
            if (size == UsefulPdfNet.text.Font.UNDEFINED)
                size = 12;
            baseFont = f.BaseFont;
            BaseFont bf = f.BaseFont;
            int style = f.Style;
            if (style == UsefulPdfNet.text.Font.UNDEFINED) {
                style = UsefulPdfNet.text.Font.NORMAL;
            }
            if (baseFont == null) {
