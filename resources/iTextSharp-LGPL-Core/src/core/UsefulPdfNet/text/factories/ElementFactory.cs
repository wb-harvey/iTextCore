...
using System.util;
using UsefulPdfNet.text;
using UsefulPdfNet.text.html;
using UsefulPdfNet.text.factories;
/*
 ...
 */
namespace UsefulPdfNet.text.factories {
    ...
    */
    ...
    public class ElementFactory {
        ...
        public static Chunk GetChunk(Properties attributes) {
            ...
            if (value != null) {
                chunk.SetTextRise(float.Parse(value, global::System.Globalization.NumberFormatInfo.InvariantInfo));
            }
            value = attributes[Markup.CSS_KEY_VERTICALALIGN];
            if (value != null && value.EndsWith("%")) {
                float p = float.Parse(value.Substring(0, value.Length - 1), global::System.Globalization.NumberFormatInfo.InvariantInfo) / 100f;
        ...
        public static Phrase GetPhrase(Properties attributes) {
            ...
            if (value != null) {
                phrase.Leading = float.Parse(value, global::System.Globalization.NumberFormatInfo.InvariantInfo);
            }
        ...
        public static Paragraph GetParagraph(Properties attributes) {
            ...
            if (value != null) {
                paragraph.IndentationLeft = float.Parse(value, global::System.Globalization.NumberFormatInfo.InvariantInfo);
            }
            value = attributes[ElementTags.INDENTATIONRIGHT];
            if (value != null) {
                paragraph.IndentationRight = float.Parse(value, global::System.Globalization.NumberFormatInfo.InvariantInfo);
            }
            return paragraph;
        }
        ...
        public static List GetList(Properties attributes) {
            ...
            value = attributes[ElementTags.INDENTATIONLEFT];
            if (value != null) {
                list.IndentationLeft = float.Parse(value, global::System.Globalization.NumberFormatInfo.InvariantInfo);
            }
            
            value = attributes[ElementTags.INDENTATIONRIGHT];
            if (value != null) {
                list.IndentationRight = float.Parse(value, global::System.Globalization.NumberFormatInfo.InvariantInfo);
            }
            
            value = attributes[ElementTags.SYMBOLINDENT];
            if (value != null) {
                list.SymbolIndent = float.Parse(value, global::System.Globalization.NumberFormatInfo.InvariantInfo);
            }
        ...
        public static Cell GetCell(Properties attributes) {
            ...
            value = attributes[ElementTags.LEADING];
            if (value != null) {
                cell.Leading = float.Parse(value, global::System.Globalization.NumberFormatInfo.InvariantInfo);
            }
        ...
        public static Table GetTable(Properties attributes) {
            ...
            if (value != null) {
                ...
                for (int i = 0; i < values.Count; i++) {
                    ...
                    widths[i] = float.Parse(value, global::System.Globalization.NumberFormatInfo.InvariantInfo);
                }
                table.Widths = widths;
            }
            else {
            ...
            if (value != null) {
                table.Spacing = float.Parse(value, global::System.Globalization.NumberFormatInfo.InvariantInfo);
            }
            value = attributes[ElementTags.CELLPADDING];
            if (value != null) {
                table.Padding = float.Parse(value, global::System.Globalization.NumberFormatInfo.InvariantInfo);
            }
            value = attributes[ElementTags.OFFSET];
            if (value != null) {
                table.Offset = float.Parse(value, global::System.Globalization.NumberFormatInfo.InvariantInfo);
            }
            value = attributes[ElementTags.WIDTH];
            if (value != null) {
                if (value.EndsWith("%"))
                    table.Width = float.Parse(value.Substring(0, value.Length - 1), global::System.Globalization.NumberFormatInfo.InvariantInfo);
                else {
                    table.Width = float.Parse(value, global::System.Globalization.NumberFormatInfo.InvariantInfo);
                    table.Locked = true;
                }
            }
        ...
        */
        private static void SetRectangleProperties(Rectangle rect, Properties attributes) {
            ...
            if (value != null) {
                rect.BorderWidth = float.Parse(value, global::System.Globalization.NumberFormatInfo.InvariantInfo);
            }
            int border = 0;
            ...
            if (r != null || g != null || b != null) {
                ...
                if (value != null) {
                    rect.GrayFill = float.Parse(value, global::System.Globalization.NumberFormatInfo.InvariantInfo);
                }
            }
        }
        ...
        private static void SetSectionParameters(Section section, Properties attributes) {
            ...
            if (value != null) {
                section.Indentation = float.Parse(value, global::System.Globalization.NumberFormatInfo.InvariantInfo);
            }
            value = attributes[ElementTags.INDENTATIONLEFT];
            if (value != null) {
                section.IndentationLeft = float.Parse(value, global::System.Globalization.NumberFormatInfo.InvariantInfo);
            }
            value = attributes[ElementTags.INDENTATIONRIGHT];
            if (value != null) {
                section.IndentationRight = float.Parse(value, global::System.Globalization.NumberFormatInfo.InvariantInfo);
            }
        }
        ...
        public static Image GetImage(Properties attributes) {
            ...
            if ((x != null) && (y != null)) {
                image.SetAbsolutePosition(float.Parse(x, global::System.Globalization.NumberFormatInfo.InvariantInfo),
                        float.Parse(y, global::System.Globalization.NumberFormatInfo.InvariantInfo));
            }
            value = attributes[ElementTags.PLAINWIDTH];
            if (value != null) {
                image.ScaleAbsoluteWidth(float.Parse(value, global::System.Globalization.NumberFormatInfo.InvariantInfo));
            }
            value = attributes[ElementTags.PLAINHEIGHT];
            if (value != null) {
                image.ScaleAbsoluteHeight(float.Parse(value, global::System.Globalization.NumberFormatInfo.InvariantInfo));
            }
            value = attributes[ElementTags.ROTATION];
            if (value != null) {
                image.Rotation = float.Parse(value, global::System.Globalization.NumberFormatInfo.InvariantInfo);
            }
            return image;
        }
        ...
        */
        public static Annotation GetAnnotation(Properties attributes) {
            ...
            if (value != null) {
                llx = float.Parse(value, global::System.Globalization.NumberFormatInfo.InvariantInfo);
            }
            value = attributes[ElementTags.LLY];
            if (value != null) {
                lly = float.Parse(value, global::System.Globalization.NumberFormatInfo.InvariantInfo);
            }
            value = attributes[ElementTags.URX];
            if (value != null) {
                urx = float.Parse(value, global::System.Globalization.NumberFormatInfo.InvariantInfo);
            }
            value = attributes[ElementTags.URY];
            if (value != null) {
                ury = float.Parse(value, global::System.Globalization.NumberFormatInfo.InvariantInfo);
            }
