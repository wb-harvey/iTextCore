...
namespace UsefulPdfNet.text {
    ...
    ///     HtmlWriter.GetInstance(<strong>document</strong>, global::System.out);
    ...
    public class Document : IDocListener {
        ...
        * @since	2.1.6
        */
	    private const String ITEXT = "UsefulPdfNet";
        /**
        * This constant may only be changed by Paulo Soares and/or Bruno Lowagie.
        * @since	2.1.6
        */
        ...
        */
        ...
        /// Has three overloads.
        /// </overloads>
        public Document() : this(UsefulPdfNet.text.PageSize.A4) {}
