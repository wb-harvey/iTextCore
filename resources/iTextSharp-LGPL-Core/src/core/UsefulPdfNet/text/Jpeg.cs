...
namespace UsefulPdfNet.text {
    ...
    /// <seealso cref="T:UsefulPdfNet.text.Png"/>
    public class Jpeg : Image {
        ...
        private void ProcessParameters() {
                    ...
                    if (v == 0xFF) {
                        ...
                        if (marker == M_APPE) {
                            ...
                            if (byteappe.Length >= 12) {
                                string appe = global::System.Text.ASCIIEncoding.ASCII.GetString(byteappe,0,5);
                        ...
                        if (marker == M_APP2) {
                            ...
                            if (byteapp2.Length >= 14) {
                                String app2 = global::System.Text.ASCIIEncoding.ASCII.GetString(byteapp2, 0, 11);
            ...
            if (icc != null) {
                ...
                total = 0;
                for (int k = 0; k < icc.Length; ++k) {
                    global::System.Array.Copy(icc[k], 14, ficc, total, icc[k].Length - 14);
                    total += icc[k].Length - 14;
                }
                try {
